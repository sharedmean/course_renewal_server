...
from models import listeners_courses
...
config.set_section_option(section, "DB_PASS", environ.get("DB_PASSWORD", '123'))
config.set_section_option(section, "DB_NAME", environ.get("DB_NAME", 'DPO'))
